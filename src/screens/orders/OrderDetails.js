...
const styles = StyleSheet.create({
  ...
  inputContainer: {
    ...
    width: '100%', // Ensure the input container takes up the full width
    paddingHorizontal: 10, // Optional: Add some padding if needed
    position: 'relative', // Keep position relative to the container
  },
  floatingLabel: {
    position: 'absolute',
    marginTop: 5,
